...
#    CHD2[(tdir == 'Af') & (edir == -1)] = CHB2[(tdir == 'Af') & (edir == -1)]
    ...
    timedat.CHC1[list(switch_counters)] = np.mean(timedat.CHC1)
    timedat.CHC3[list(switch_counters)] = np.mean(timedat.CHC3)
    timedat.CHD1[list(switch_counters)] = np.mean(timedat.CHD1)
    timedat.CHD3[list(switch_counters)] = np.mean(timedat.CHD3)
